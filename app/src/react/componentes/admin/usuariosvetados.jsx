...
<button onClick={()=>{dispatch(assign(<VetoMenu id={props.id} />))}} className=" hover:bg-moradoLight ml-auto   rounded-md p-1  w-2/6 border-2 border-moradoLight bg-moradoFondo placeholder-gray-400  placeholder-gray-400 ">Vetar usuario</button>
...
bannedUsers.map((item,index)=>{
   return  (
   <div className='flex mt-2 '  id={index++}>
