...
const Header = () => {
    ...
    return (<>
        ...
        <div className=" pt-5  items-center bg-moradoOscuro  m-0 sticky top-0 justify-center  z-30 flex w-full  border-b-solid border-b-2 border-b-naranjaMolon " id='header-feed'>
