...
<div className ='flex '>
        <div style={{marginTop:'10px', width:'60%'}}  className='  flex flex-col items-center'>
       ...
       {/* <span>a</span> */}
        ...
        <div style={{marginTop:'10px', width:'40%'}} className=''>
        ...
        <div style={{marginTop:'10px', width:'60%', marginLeft:'2%'}} >
